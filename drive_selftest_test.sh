...
#  4. Add Check if Short Test is completed.
#  5. Add Check if Long Test is completed for NVMe or SSD ONLY.
#
...
####################################################################################################################################################
	...
	if [[ $UpdateDriveAvailable == "true" ]]; then
		echo "Update is Available -- Use the '-update' switch to update the script."
	fi
...
help_text () {
	...
	echo "edit lines (around line 100) '######### USER SETTINGS #########' as desired."
    echo " "
